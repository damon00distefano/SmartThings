...
metadata {
	...
	tiles(scale: 2) {
		...
		standardTile("playCarAlarm", "device.status", width: 2, height: 2) {
state "default", label:'Car Alarm', action:"siren1", icon:"st.security.alarm.clear",backgroundColor: "#ff3333"
}

standardTile("playAlarmLow", "device.status", width: 2, height: 2) {
state "default", label:'Alarm', action:"bell1", icon:"st.security.alarm.clear",backgroundColor: "#ff3333"
}

standardTile("playAlarmHigh", "device.status", width: 2, height: 2) {
state "default", label:'Alarm High', action:"chime3", icon:"st.security.alarm.clear",backgroundColor: "#ff3333"
}

standardTile("playRedAlert", "device.status", width: 2, height: 2) {
state "default", label:'Red Alert', action:"bell2", icon:"st.security.alarm.clear",backgroundColor: "#ff6666"
}

standardTile("playPolice", "device.status", width: 2, height: 2) {
state "default", label:'Police', action:"bell3", icon:"st.security.alarm.clear",backgroundColor: "#ff6666"
}

standardTile("playPoliceHigh", "device.status", width: 2, height: 2) {
state "default", label:'Police High', action:"bell4", icon:"st.security.alarm.clear",backgroundColor: "#ff6666"
}

standardTile("playBellChime", "device.status", width: 2, height: 2) {
state "default", label:'Bells', action:"bell5", icon:"st.Seasonal Winter.seasonal-winter-002",backgroundColor: "#99FF99"
}

standardTile("playWind", "device.status", width: 2, height: 2) {
state "default", label:'Wind', action:"siren2", icon:"st.Seasonal Winter.seasonal-winter-002",backgroundColor: "#99FF99"
}

standardTile("playDoorbell", "device.status", width: 2, height: 2) {
state "default", label:'Doorbell', action:"chime1", icon:"st.Seasonal Winter.seasonal-winter-002",backgroundColor: "#99FF99"
}

standardTile("playRobobuzz", "device.status", width: 2, height: 2) {
state "default", label:'Robobuzz', action:"chime2", icon:"st.Entertainment.entertainment2",backgroundColor: "#CC99CC"
}
		...
		main "status"
		details("status", "playAlarm", "turnOff", "refresh",
"playCarAlarm", "playAlarmLow", "playAlarmHigh",
"playRedAlert", "playPolice", "playPoliceHigh",
"playBellChime", "playWind", "playDoorbell",
"playRobobuzz", "battery") }
